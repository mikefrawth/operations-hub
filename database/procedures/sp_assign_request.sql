...
proc: BEGIN
    ...
    -- Unexpected SQL failures must never leave transaction cleanup to connection-pool behavior.
    ...
    ELSE
        -- Lock the matching Identity rows so Technician eligibility cannot change before commit.
        SELECT app_user.Id
