...
public sealed record OpenRequestSummaryQuery(int Page = 1, int PageSize = 25);
...
public enum ProcedureAssignmentStatus { Success, NotFound, Conflict, Closed, InvalidAssignee }
